...
public class MainActivity extends AppCompatActivity {
    ...
    public void addData(DatabaseHelper myDB) {
        myDB.insertTable1("Janhvi Singh", "janhvisingh1110@gmail.com", R.drawable.person1, 1000);
        myDB.insertTable1("Elon Musk", "elonmusk11@gmail.com", R.drawable.person2, 1000);
        myDB.insertTable1("Jack Ma", "Jackma@gmail.com", R.drawable.person3, 1000);
        myDB.insertTable1("Scott Ryan", "ScottRyan@gmail.com", R.drawable.person4, 1000);
        myDB.insertTable1("Meera Roy", "MeeraRoy@gmail.com", R.drawable.person5, 1000);
        myDB.insertTable1("Barbara Palvin", "barbara@gmail.com", R.drawable.person6, 1000);
        myDB.insertTable1("Anita Singh", "Anita1122@gmail.com", R.drawable.person7, 1000);
        myDB.insertTable1("Jennifer Williams", "Jenniferw@gmail.com", R.drawable.person8, 1000);
